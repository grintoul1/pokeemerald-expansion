...
const struct SpriteFrameImage gTrainerBackPicTable_MagmaLeaderMaxie[] =
{
    {gTrainerBackPic_MagmaLeaderMaxie + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_MagmaLeaderMaxie + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_MagmaLeaderMaxie + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
