...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, TRAINER_ROSE_5, ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, TRAINER_ANDRES_5, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, TRAINER_DUSTY_5, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, TRAINER_LOLA_5, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, TRAINER_RICKY_5, ROUTE109),
    ...
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_3, TRAINER_VALERIE_3, TRAINER_VALERIE_3, TRAINER_VALERIE_4, TRAINER_VALERIE_5, MT_PYRE_6F),
    ...
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_2, TRAINER_BERNIE_2, TRAINER_BERNIE_3, TRAINER_BERNIE_4, TRAINER_BERNIE_5, ROUTE114),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_AQUA_MIXED
